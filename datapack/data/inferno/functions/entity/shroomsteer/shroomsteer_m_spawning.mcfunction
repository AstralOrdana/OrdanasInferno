...
execute as @s at @s if predicate inferno:biomes/infestedwastes unless score $Ordana-NS-ShroomsteerMobCap OrdN-S_MobCap matches 30.. run function inferno:entity/shroomsteer/shroomsteer_m_spawned
execute as @s at @s if predicate inferno:biomes/infestedwastes run tp ~ -60 ~