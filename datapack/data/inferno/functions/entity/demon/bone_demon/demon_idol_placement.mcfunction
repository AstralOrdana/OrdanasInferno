...
execute as @e[type=villager,tag=Orda-NS-VillagerDemonIdol,tag=!Orda-NS-VillagerDemonIdolRot,distance=..0.5] at @s if predicate nether-survival:25_chance run data merge entity @s {Rotation:[-90F,0F]}
