execute if entity @a[distance=10..50,gamemode=!creative,gamemode=!spectator] run scoreboard players add @s OrdN-S_AtkTime 1
execute if entity @s[nbt={RoarTicks:20},scores={OrdN-S_AtkTime=..6}] run scoreboard players add @s 3
execute if entity @s[nbt={Health:..40}] if entity @a[distance=10..50,gamemode=!creative,gamemode=!spectator] run scoreboard players add @s 1
