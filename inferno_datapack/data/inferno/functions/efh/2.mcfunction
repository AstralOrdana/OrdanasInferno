...
execute if predicate inferno:biomes/moonstone_biome run loot spawn ~ ~ ~ loot inferno:enchanting/lunar_valley/2
...
execute if predicate inferno:biomes/black_biome run loot spawn ~ ~ ~ loot inferno:enchanting/sulfuric_desert/2
...
advancement grant @a[distance=..12] only inferno:inferno/altar_lvl_2
