...
execute if predicate inferno:biomes/moonstone_biome run loot spawn ~ ~ ~ loot inferno:enchanting/lunar_valley/3
...
execute if predicate inferno:biomes/black_biome run loot spawn ~ ~ ~ loot inferno:enchanting/sulfuric_desert/3
...
advancement grant @a[distance=..12] only inferno:inferno/altar_lvl_3
