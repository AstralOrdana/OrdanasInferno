execute if block ^ ^ ^0.5 #inferno:altar positioned ^ ^ ^0.5 align x align y align z positioned ~0.5 ~1 ~0.5 as @e[type=item,distance=..1,nbt={Item:{id:"minecraft:lapis_lazuli",Count:1b}}] run function inferno:altar_power_get
